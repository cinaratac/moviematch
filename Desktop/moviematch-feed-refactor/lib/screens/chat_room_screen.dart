...
class _ChatAppBarTitle extends StatelessWidget {
  ...
  Widget _makeTile(BuildContext context, String title, String photoUrl) {
  ...
  Widget build(BuildContext context) {
    if ((initialTitle ?? '').isNotEmpty) {
      // Early return if initialTitle is provided and non-empty.
      return _makeTile(context, initialTitle!, '');
    }
    ...
    return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snap) {
        ...
        if (titleFromChat.isNotEmpty || photoFromChat.isNotEmpty) {
          return _makeTile(context, titleFromChat, photoFromChat);
        }
        ...
        return FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          future: (() async {
            final ref = FirebaseFirestore.instance
                .collection('matches')
                .doc(chatId);
            var s = await ref.get(const GetOptions(source: Source.cache));
            if (!s.exists) {
              s = await ref.get(const GetOptions(source: Source.server));
            }
            return s;
          })(),
          builder: (context, mSnap) {
            ...
            if (mSnap.hasData && mSnap.data!.exists) {
              ...
              if (otherP != null) {
                ...
                // Removed: no longer persist minimal meta to chats for next time.
              }
            }
            ...
            return FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
              ...
              builder: (context, uSnap) {
                ...
                return _makeTile(context, uname, uphoto);
              },
            );
          },
        );
