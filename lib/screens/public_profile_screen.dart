          ...
          if (lb.isNotEmpty)
            FutureBuilder<List<LetterboxdFilm>>(
              ...
              builder: (context, s) {
                ...
                if (s.hasError) return Text('Favoriler alınamadı: ${s.error}');
                final items = s.data ?? [];
                if (items.isEmpty) return const Text('Favori film bulunamadı.');
                return SizedBox(
                  height: 180,
          ...
          if (lb.isNotEmpty)
            FutureBuilder<List<LetterboxdFilm>>(
              ...
              builder: (context, s) {
                ...
                if (s.hasError) return const Text('5★ film bulunamadı.');
                final items = s.data ?? [];
                if (items.isEmpty) return const Text('5★ film bulunamadı.');
                return SizedBox(
                  height: 180,
                  child: ListView.separated(
                    scrollDirection: Axis.horizontal,
                      ...
                      children: [
                        ...
                        SizedBox(
                          height:
                              ...
                              kToolbarHeight +
                              140,
                          child: Stack(children: [_blurBackdrop()]),
                        ),
                        Padding(
