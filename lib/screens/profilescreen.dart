...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _loadPrefs() async {
    ...
    final u = sp.getString('lb_username');
    setState(() {
      _lbUsername = u;
  ...
  Future<void> _promptLetterboxdUsername() async {
    ...
    if (result != null) {
      ...
      if (result.isEmpty) {
        ...
        await sp.setString('lb_username', result);
        setState(() {
          _lbUsername = result;
                ...
                itemBuilder: (context) => [
                  const PopupMenuItem(
                    ...
                    child: ListTile(
                      ...
                      title: Text('Letterboxd hesabını ayarla'),
                    ),
                  ),
                  if (_lbUsername != null)
                    const PopupMenuItem(
                      ...
                      child: ListTile(
                        ...
                        title: Text('Letterboxd hesabını kaldır'),
                      ),
                    ),
                  const PopupMenuItem(
                    value: 'reset',
                ...
                if (_lbUsername == null)
                  Card(
                    child: ListTile(
                      ...
                      title: const Text('Letterboxd hesabını bağla'),
                      subtitle: const Text(
                        'Favori filmlerini profilde göstermek için kullanıcı adını ekle',
                      ),
                      trailing: const Icon(Icons.chevron_right),
                      onTap: _promptLetterboxdUsername,
                    ),
                  )
                else
                  Wrap(
                    ...
                    children: [
                      Chip(
                        label: Text('Letterboxd: @$_lbUsername'),
                        onDeleted: _clearLetterboxdUsername,
                      ),
                      TextButton.icon(
                        onPressed: _promptLetterboxdUsername,
