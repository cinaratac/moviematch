...
class _OnboardingLetterboxdState extends State<OnboardingLetterboxd> {
  ...
  Future<void> _saveAndBuild() async {
    ...
    // Düzeltme: Local variable isimleri ('_' olmadan)
    bool primarySaved = false; 
    bool nonFatalErrorShown = false;
    ...
    try {
      ...
      try {
        await _retryFirestore(
          // Düzeltme: MatchService.instance.autoCreateMatches çağrılıyor
          () => MatchService.instance.autoCreateMatches(
            uid,
            minCommonFive: 1,
            minCommonFav: 1,
            minCommonDisliked: 1,
