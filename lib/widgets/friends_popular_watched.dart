            ...
            child: Row(
              children: [
                Icon(
                  ...
                  size: 19,
                  color: const Color.fromARGB(255, 36, 190, 19),
                ),
    ...
    return Tooltip(
      ...
      child: Container(
        ...
        child: watcher.photoURL.isNotEmpty
            ? Transform.scale(
                scale:
                    1.15, // İçteki resmi %15 büyütür, beyazlıklar çemberin dışına itilip kesilir.
                child: Image.network(watcher.photoURL, fit: BoxFit.cover),
              )
