...
class _BadgeProgressCard extends StatefulWidget {
  const _BadgeProgressCard();

  @override
  State<_BadgeProgressCard> createState() => _BadgeProgressCardState();
}

class _BadgeProgressCardState extends State<_BadgeProgressCard> {
...
class _TriviaLeaderCard extends StatefulWidget {
  const _TriviaLeaderCard();

  @override
  State<_TriviaLeaderCard> createState() => _TriviaLeaderCardState();
}

class _TriviaLeaderCardState extends State<_TriviaLeaderCard> {
  late final Stream<QuerySnapshot<Map<String, dynamic>>> _leaderStream;
...
class _TopClubCard extends StatefulWidget {
  const _TopClubCard();

  @override
  State<_TopClubCard> createState() => _TopClubCardState();
}

class _TopClubCardState extends State<_TopClubCard> {
  late final Future<QuerySnapshot<Map<String, dynamic>>> _topClubFuture;

  @override
  void initState() {
    super.initState();
    _topClubFuture = FirebaseFirestore.instance
        .collection('clubs')
