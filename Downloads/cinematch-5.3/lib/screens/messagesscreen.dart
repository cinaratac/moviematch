...
class _ChatsViewState extends State<_ChatsView>
  ...
  void initState() {
    super.initState();
    _initStream();
    // AI sohbet odasını (yoksa) sessizce oluştur; böylece diğer sohbetler
    // gibi bu listede de normal bir satır olarak belirir.
            ...
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              ...
              builder: (context, s) {
                ...
                for (var doc in docs) {
                  ...
                  // AI botu gerçek bir "users" dokümanı değil; onun için
                  // gereksiz profil sorgusu atmaya gerek yok.
...
class ChatListTile extends StatelessWidget {
  ...
  Widget _buildTile(
    ...
    return ListTile(
      ...
      leading: InkWell(
        // AI odasının avatarına tıklamak da (gerçek bir profili olmadığı
        // için) sohbet odasını açar; insan sohbetlerinde ise profile gider.
        onTap: isAi
            ? openRoom
            : () => Navigator.push(
                context,
